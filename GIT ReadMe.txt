...
5.In Advance enter the application name (Ex - in my case I entered UserApplication. If it doesnt work try to enter /UserApplication/Pom.xml ....do some R&D if it fails)
...
6. Jenkins workspace location is C:\Program Files (x86)\Jenkins\workspace\jenkins_maven\
	Basically, Jenkins downloads from the Repo and creates a new project under Jenkins_maven folder. And then issue a mvn pom command on it to do a build
...
Now next will be how to do, build+package+deploy together